 ...
 * </ol>
 */
public class TranstionReconnectCommand extends Command {
	 ...
	 *             if conn is null
	 */
	public TranstionReconnectCommand(Transition conn) {
		if (conn == null) {
	...
	private boolean checkSourceReconnection() {
		...
		for (Iterator iter = newSource.getSourceTransitions().iterator(); iter
				.hasNext();) {
	...
	private boolean checkTargetReconnection() {
		...
		// return false, if the connection exists already
		for (Iterator iter = newTarget.getTargetTransition().iterator(); iter
				.hasNext();) {
			Transition conn = (Transition) iter.next();
